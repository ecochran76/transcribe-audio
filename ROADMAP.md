...
- AuraCall choices integration now gives the Settings/Intelligence surface a
  redacted readiness source for selected transcript agents or dispatch-pool
  teams while keeping transcript prompts, readout schemas, ledgers, and
  materialization in this repo.
