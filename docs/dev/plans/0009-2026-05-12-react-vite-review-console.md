...
7. In progress: Intelligence-management surfaces now show provider readiness,
   ...
   affordances, and prepared App Intelligence run ledgers without starting
   provider work.
