...
service. A4 consumes these metadata contracts in a zero-provider-write
evidence supervisor on synthetic and redacted inputs. It doesn't open private
corpus, provider, enrollment, publication, or deployment effects.
